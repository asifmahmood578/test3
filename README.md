...
import * as fromLearning_path_by_user from '../actions/learning_path_by_user.actions';
import * as fromStore from '@palmyra/store';

@Injectable()
export class Learning_path_by_userUserViewCollectionEffectsBase {

  constructor(private actions$: Actions) {}

  /**
   * Navigate back to SAME screen after delete
   * (Named outlet: completion)
   */
    ...
    this.actions$.pipe(
      ...
      switchMap((context: any) => {
        ...
        const navigationContext = {
          ...
          // IMPORTANT: parent screen
          screen: 'user-view',

          // IMPORTANT: named outlet navigation
          outlets: {
            completion: ['completion', 'user-view-collection']
          },
        ...
        return [
          ...
          // Navigate to same URL after delete
